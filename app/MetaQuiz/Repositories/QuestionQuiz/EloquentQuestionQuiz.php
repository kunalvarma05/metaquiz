<?php
namespace MetaQuiz\Repositories\QuestionQuiz;

use MetaQuiz\Repositories\AbstractEloquentRepository;
use MetaQuiz\Service\Cache\CacheInterface;
use Illuminate\Database\Eloquent\Model;

class EloquentQuestionQuiz extends AbstractEloquentRepository implements QuestionQuizInterface {
	...
	/**
	 * __construct Create a new Eloquent QuestionQuiz
