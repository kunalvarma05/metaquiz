...
<div class="courses-page">
	<div class="container-sm page-center-1">
		<div class="brick brick-shadow">
			...
			<div class="well-sm">
				{{Form::open(array('route' => array('management.courses.subjects.chapters.questions.destroy', $course->id, $subject->id, $chapter->id, $question->id), 'method' => "DELETE", 'onsubmit' => "return confirm('Are you sure you want to delete this question? It is irreversible!');"))}}
